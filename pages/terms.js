                ...
                <Container>
                    <Row>
                        <Col xs={12} xl={12} className='about-font-18'>
                            ...
                            <p> Except as expressly stated herein, travelflys assumes no responsibility for actions relating to travel services beyond the control of travelflys or its employees. travelflys is not responsible or liable for any act, error, omission, injury, loss, accident, damage, delay, nonperformance, irregularity, or any consequence thereof, which may be occasioned through neglect, or default or any other act or inaction of any Travel Supplier. flyinate shall not be liable for any fluctuation in price or change in schedule or equipment or accommodations for any travel service, which occurs subsequent to booking and payment for such service. travelflys shall not be liable for any cancellation, overbooking, delay, re-routing, strike, any weather occurrence or governmental occurrence as it affects your travel reservation made with us. flyinate shall not be liable for the depiction of travel products and services made available by any supplier of travel products and services, including but not limited to photographs, listed amenities, ratings, and discounts </p>
