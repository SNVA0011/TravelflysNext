        ...
        singleAirport?.length > 0 ?
          <>
            ...
            <Head>
              ...
              <link rel="canonical" href={`https://www.travelflys.com/airlines/${singleAirport[0].pageType}/${singleAirport[0].url}`} />
            </Head>
              ...
              <div className="d-flex align-items-center justify-content-center flex-column page-title page-title--small page-title--blog text-center">
                <div className="container">
                  <div className="page-title__content">
                    <div className="page-title__name">{ReactHtmlParser(singleAirport[0].heading)}</div>
                ...
                <BreadHero linkhtml={<>
                  <ul className="bradcum container">
                    ...
                    <li className='mr-2'>/</li>
                    <li> <Link href={`/airlines/${singleAirport[0].pageType}`}>{singleAirport[0].pageType.replaceAll('-', ' ')}</Link> </li>
                    <li className='mr-2'>/</li>
              ...
              <div className='popular-destination blogaddalist details full-w'>
                ...
                {singleAirport && allAirport ?
                  <OtherOffices
                    ...
                    viewMore={`View more`}
                    viewMoreBtn={true}
                    viewMorePath={`/airlines/${singleAirport[0].pageType}`}
