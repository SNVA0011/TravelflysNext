...
export default function News(props) {
  ...
  return (
    ...
    <>
      <Head>
        <title>Latest Travel News | travel and tourism news - travelflys.com	</title>
        <meta name="description" content="If you are looking for the latest travel information on various airlines. Get the latest information about airline flight schedules and regulations right here on Travelflys." />
        <meta name="keywords" content="flight news, airlines updates, Latest travel news, travel and tourism news today, travel news airlines, international travel news " />
