...
export default function ChangeCountryMenu() {
    ...
    return (
        <DropdownButton title={<><span><img src="/images/GB.png" className='eps-rec' />  {lang} </span> </>} variant="outline-secondary" className='order-lg-3 ml-auto mr-3 mr-lg-0 ml-0 ml-lg-3 btnlang'>
