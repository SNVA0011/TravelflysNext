			...
			<div className="cities">
				<div className="container">
					...
					<div className="row">
							...
							<div className="col-xl-3 col-lg-4 col-sm-6 col-12">
								<Link href="/es/vuelos/united-airlines-UA">
									<a className="cities__item hover__box">
										<div className="cities__thumb hover__box__thumb">
							...
							<div className="col-xl-3 col-lg-4 col-sm-6 col-12">
								<Link href="/es/vuelos/copa-airlines-CM">
									<a className="cities__item hover__box">
										<div className="cities__thumb hover__box__thumb">
							...
							<div className="col-xl-3 col-lg-4 col-sm-6 col-12">
								<Link href="/es/vuelos/alaska-airlines-AS">
									<a className="cities__item hover__box">
										<div className="cities__thumb hover__box__thumb">
											<Image src="/images/airlineone.jpg" alt="Aer Lingus" width={640} height={427}/>
										</div>
							...
							<div className="col-xl-3 col-lg-4 col-sm-6 col-12">
								<Link href="/es/vuelos/british-airways-BA">
									<a className="cities__item hover__box">
										<div className="cities__thumb hover__box__thumb">
											<Image src="/images/airlineone.jpg" alt="Aer Lingus" width={640} height={427}/>
							...
							<div className="col-xl-3 col-lg-4 col-sm-6 col-12">
								<Link href="/es/vuelos/klm-airlines-KL">
									<a className="cities__item hover__box">
										<div className="cities__thumb hover__box__thumb">
											<Image src="/images/airlineone.jpg" alt="Aer Lingus" width={640} height={427}/>
