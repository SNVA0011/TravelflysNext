                                ...
                                <ul className='navbar-nav'>
                                    <li className='nav-item mx-lg-2'>
                                        <Link href="/it/">
                                            ...
                                            className={'nav-link ' + (location.pathname === "/it" ? 'active' : '')}>
                                                Casa
                                            </a>
                                        </Link>
                                    </li>
                                    <li className='nav-item mx-lg-2'>
                                        <Link href="/it/chi-siamo">
                                            <a onClick={() => window.innerWidth < 1200 ? setExpanded(expanded ? false : "expanded") : ''} 
                                            className={'nav-link ' + (location.pathname === "/it/chi-siamo" ? 'active' : '')}>
                                                Chi Siamo
                                            </a>
                                        </Link></li> 
                                    <li className='nav-item mx-lg-2'>
                                        <Link href="/it/articolo">
                                            <a onClick={() => window.innerWidth < 1200 ? setExpanded(expanded ? false : "expanded") : ''} 
                                            className={'nav-link ' + (location.pathname === "/it/articolo" || location.pathname === "/it/articolo/[blogDetail]" ? 'active' : '')}>
                                                Articolo
                                            </a>
                                        </Link>
                                    </li> 
